...
-(void)mcCachedRequestFinishLoading:(bool)success LoadFromCache:(bool)cache error:(NSString *)error data:(NSMutableData *)data
{
    if (success) {
        ...
        [randomRequest launchPostRequestForRandom:@"https://masterchan.me:1024/v22/random.php" ignoreCache:YES];
    }else{
...
-(void)getARandom
{
    ...
    [randomRequest launchPostRequestForRandom:@"https://masterchan.me:1024/v22/random.php" ignoreCache:NO];
}
