...
- (void)resetFiles
{
    ...
    tempFile = @"<!DOCTYPE html><html lang=\"zh\" dir=\"ltr\" class=\"client-nojs\"><head><title>iOS App 2.0</title><meta charset=\"UTF-8\" /><link rel=\"stylesheet\" href=\"http://bits.moegirl.org/zh/load.php?debug=false&amp;lang=zh&amp;modules=ext.echo.badge%7Cext.gadget.Backtotop%2CForce_preview%2CSearchbox-popout%7Cext.rtlcite%7Cmediawiki.legacy.commonPrint%2Cshared%7Cmediawiki.skinning.interface%7Cmediawiki.ui.button%7Cskins.vector.styles&amp;only=styles&amp;skin=vector&amp;*\" /><link rel=\"stylesheet\" href=\"http://bits.moegirl.org/zh/load.php?debug=false&amp;lang=zh&amp;modules=site&amp;only=styles&amp;skin=vector&amp;*\" /><script src=\"http://bits.moegirl.org/zh/load.php?debug=false&amp;lang=zh-cn&amp;modules=startup&amp;only=scripts&amp;skin=vector&amp;*\"></script></head><body class=\"mediawiki ltr sitedir-ltr ns-0 ns-subject page-LoveLive skin-vector action-view vector-animateLayout\">";
    ...
    tempFile = @"<!DOCTYPE html><html lang='zh-CN'><head>	<!--%@-->	<meta charset='UTF-8'>	<meta name='viewport' content='width=device-width, initial-scale=1'></head><body>	<style type='text/css'>	ul{padding-left: 20px;} body{		font-size: 11px;	}	</style>	<div id='content'>		<h3>出现了点问题哎~~!</h3>		<p>错误信息: <strong>%@</strong></p>		<p>您可以做的事情有：</p>		<ul>			<li>提交此页面的错误报告，帮助我们改进程序</li>			<li>到网络环境更好的地方再试一试</li>			<li>使用黑科技保护您的手机与萌百服务器之间的连接</li>		</ul>	</div></body></html>";
