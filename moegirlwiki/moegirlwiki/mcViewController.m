...
NSString * baseID = @"moegirl-app-2.0";//用于GoogleAnalytics等统计工具识别   (15个字符)
NSString * homepagelink = @"https://masterchan.me/moegirlwiki/index2.0.php";//主页所在的位置
NSString * API = @"http://zh.moegirl.org/%@";//用于获取页面的主要链接
NSString * APIrandom = @"https://masterchan.me/moegirlwiki/random2.0.php";//获取随机页面的API
